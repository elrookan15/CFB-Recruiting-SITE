...
> **Repo integration (CFB-Recruiting-SITE):**
...
> - Stack in this repo: Vite + React 19 SPA + strict TypeScript + Tailwind CSS + Express backend (`server.ts`). No Supabase in this repo — apply the RLS-first principle as strict **server-side** authorization enforcement; never trust client-side filters.
