...
export const TopWeeklyHighlights: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Memoized highlight filtering and sorting
  // Impact: Prevents O(N log N) recalculations on every keystroke in the submission form inputs, improving typing responsiveness.
