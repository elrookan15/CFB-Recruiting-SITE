...
export const CampSearchEngine: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Memoized camp search filtering
  // Impact: Prevents O(N) recalculations and multiple string operations on every render,
  // especially when typing reviews in the modal which causes state changes unrelated to filtering.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Filter by Zip Code (e.g. 75001)..."
              className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-10 pr-3 py-2 text-xs text-white focus:outline-none focus:border-emerald-500"
            />
          </div>
