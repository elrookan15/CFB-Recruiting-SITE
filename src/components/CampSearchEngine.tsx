...
export const CampSearchEngine: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Memoized camp filtering
  // Impact: Prevents O(N) recalculations on every render, preserving object stability for child components and improving rendering speed when unrelated state changes.
