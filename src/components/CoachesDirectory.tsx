...
export const CoachesDirectory: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Memoize the filtered coaches array.
  // Impact: Prevents O(N) re-filtering of 450+ coaches on every keystroke when typing a direct message in the modal.
